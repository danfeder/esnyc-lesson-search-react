/**
 * @description Configure search synonyms in Algolia for ingredient groupings and cultural hierarchies
 * @requires Environment variables: VITE_ALGOLIA_APP_ID, ALGOLIA_ADMIN_API_KEY
 * @requires File: algolia-synonyms.json in project root
 * @example
 * npm run configure-synonyms
 * # or
 * node scripts/configure-synonyms.js
 *
 * @notes
 * - Clears existing synonyms before adding new ones
 * - Adds ingredient groupings (e.g., "butternut squash" → "winter squash")
 * - Adds cultural heritage synonyms
...
const requiredEnvVars = ['VITE_ALGOLIA_APP_ID', 'ALGOLIA_ADMIN_API_KEY'];
...
/**
 * Configure Algolia synonyms from JSON file
 * @returns {Promise<void>}
 * @throws {Error} If file read fails or Algolia API calls fail
 */
