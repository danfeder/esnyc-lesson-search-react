...
- **Branch base:** continue on `docs/stage1-heritage-european-cluster` (no branch switch); PR #487 already open with 2 commits (`49a98be` cluster fill + `f2bdabe` pre-push fix-ups).
