...
| **4** | Data / corpus cleanup (DB-careful) | ✅ **DONE 2026-06-22** — reshaped 4→3 PRs | #538 `9f75a15` (C12+C83) · #539 `af75f65` (C11 hard-delete + C49) · #540 `9db76d3` (C88 dev-seed) — all merged + verified | — (closed); C08 closed as no-op; **C02 → own `scripts/stage2-retag` session**; defer `C01`/`C09`+`C07`/`C03` | `2026-06-22-wave4-data-corpus-cleanup-{design,implementation,execution-status}.md` |
| **5** | Reviewer/admin features | 🟡 **scaffolded 2026-06-26** (design Draft; GATE 1A folded) | `chore/wave5-scaffold` (not pushed) | **Session 1 = design-lock** (design §4 Q1–Q9) → PR 0 ReviewDetail safety net → decompose → C107 → C111/112/113 → admin tail | `2026-06-26-wave5-reviewer-admin-{design,implementation,kickoff,execution-status}.md` |
