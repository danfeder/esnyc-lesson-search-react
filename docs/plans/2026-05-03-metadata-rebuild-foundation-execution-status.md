...
- **Active branch:** `docs/stage1-heritage-middle-eastern-cluster` (Session 70 Middle Eastern cluster per-value entries; PR #488 OPEN, in Session 71 review cycle).
