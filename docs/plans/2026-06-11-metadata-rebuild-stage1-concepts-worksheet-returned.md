...
<!-- RETURNED VERDICT RECORD (archived 2026-06-11).
     This is the curriculum-team review-tool export of the Session-81 worksheet:
     all 208 verdicts decided (119 keep / 82 merge / 7 drop), all 5 cluster
     signals answered, no curriculum notes written during review.
     Three post-return corrections applied 2026-06-11 per user direction, each
     documented in the affected entries' curriculum_notes:
       1. preservation/food_preservation merge cycle -> `preservation` survives
       2. sorting/categorization merge cycle -> `sorting` survives, relabeled
          "Sorting and Categorization" (key rename deferred to canonicalization)
       3. seasonal_changes folded into seasonality (inbound folds re-pointed)
     The source worksheet (2026-05-12-metadata-rebuild-stage1-concepts-worksheet.md)
     remains the unfilled pre-handoff version; this file is the decisions record.
-->

<!-- Cluster-signal verdicts captured by curriculum-team review tool:
     - CON-12 Writing-cluster canonical shape: Keep `writing` 8 as catch-all + sub-types stay canonical
     - CON-16 Indigenous-cluster cross-field overlap (concepts × heritage): Keep concepts-side as separate singleton canonicals
     - CON-22 Reading-cluster boundary: Merge specific reading sub-types into `reading`
     - CON-23 Measurement-cluster boundary: Merge specific sub-types into `measurement` parent
     - CON-24 Figurative-language cluster: Keep `figurative_language` parent + 3 specific sub-types
-->
...
- curriculum_notes: Sole survivor of the seasonal family (2026-06-11): absorbs `seasonal_changes`, `seasonal_change`, `seasons`, `seasonal_eating`, `seasonal_cycles`.
...
- curriculum_notes: Export kept both `seasonal_changes` and `seasonality` (flagged near-duplicates); resolved 2026-06-11: combine into `seasonality` alone. Inbound folds (`seasonal_change`, `seasons`) re-pointed to `seasonality`.
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: nutrition_education
- theme_overlap: none
...
- curriculum_notes: Survivor of the preservation/food_preservation pair (export had each folding into the other; cycle resolved 2026-06-11: keep `preservation`).
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: plant_identification
- theme_overlap: none
...
- curriculum_notes: Target re-pointed from `seasonal_changes` to `seasonality` when the two were combined (2026-06-11).
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: social_justice_issues
- theme_overlap: none
...
- curriculum_notes: Folds into `sorting` (export had a circular pair; resolved 2026-06-11 — combined concept renamed "Sorting and Categorization").
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: vocabulary_development
- theme_overlap: none
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: environmental_justice
- theme_overlap: none
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: cultural_traditions
- theme_overlap: none
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: cultural_narratives
- theme_overlap: none
...
- curriculum_notes: Folds into `preservation` (export had a circular pair; resolved 2026-06-11 with `preservation` as the surviving name).
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: figurative_language
- theme_overlap: none
...
- canonical_label: Sorting and Categorization
- verdict: keep
- frequency: 1 appearances
- current_subjects: Math (1)
- recommended_primary_subject: Math
...
- curriculum_notes: Survivor of the sorting/categorization pair (export had each folding into the other; resolved 2026-06-11): keep this entry, absorb `categorization`, and rename the combined concept "Sorting and Categorization" (key rename to `sorting_and_categorization` deferred to canonicalization).
...
- recommended_secondary_subjects: <none>
- merge_aliases: <none>
- merge_into: sensory_exploration
- theme_overlap: none
