...
-- NOTE: resolve_duplicate_group is updated in 20251203_update_resolve_duplicate_group_permissions.sql
-- to use the shared permission helper. This migration only handles the detection functions.
...
-- Then recreate original functions without permission checks (from 20251201 migration)
