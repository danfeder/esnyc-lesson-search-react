...
-- =====================================================
-- Created: 2025-10-01
-- Purpose: Establish production schema as the source of truth
-- 
-- BACKGROUND:
-- This migration synchronizes local development with the actual production database.
-- Over 6 months of development, production schema evolved beyond the committed
-- migration files. This snapshot captures production state as of October 2025.
--
-- WHAT THIS DOES:
-- - Creates 9 missing tables (bookmarks, saved_searches, canonical_lessons, etc.)
-- - Updates search_lessons function to use normalized TEXT[] columns
-- - Adds search expansion functions (synonyms, cultural hierarchy)
-- - Replaces duplicate_pairs with canonical_lessons (production approach)
-- - Synchronizes all RLS policies with production
-- - Adds missing indexes and constraints
--
-- PRODUCTION STATE:
-- - 1,098 lessons with normalized TEXT[] filter columns
-- - 60 search synonyms for query expansion
-- - 127 archived lessons from duplicate resolution
-- - 127 submissions processed, 133 reviews completed
-- - 86 duplicate resolutions tracked
--
-- MIGRATION STRATEGY:
-- This snapshot was generated via:
--   supabase db dump --linked --schema public
-- 
-- All pre-snapshot migrations have been archived to:
--   supabase/migrations/archive/pre-snapshot/
--
-- Future migrations should build incrementally on this baseline.
--
-- ROLLBACK:
-- To rollback, restore the pre-snapshot migrations and run:
--   supabase db reset
-- =====================================================

-- =====================================================
-- EXTENSIONS (Required for production schema)
-- =====================================================
