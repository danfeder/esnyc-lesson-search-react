...
export function matchesCulturalHeritage(lessonCultures: string[] | undefined, selectedCultures: string[]): boolean {
...
export function matchesSeasonFilter(lesson: Lesson, selectedSeasons: string[], includeAllSeasons: boolean): boolean {
