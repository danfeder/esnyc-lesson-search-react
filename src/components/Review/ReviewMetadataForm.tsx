            ...
            <div key={key} className="space-y-1">
                ...
                {config.type === 'creatable' ? (
                    ...
                    <select
                        ...
                        className={`w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${error ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''
                            }`}
                        aria-invalid={!!error}
                    >
            ...
            <div className="mb-4">
                ...
                <div className="mt-3">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                            className={`h-2 rounded-full transition-all duration-300 ${fieldProgress.percentage === 100
                                    ? 'bg-green-600'
