...
export function DuplicateResolution({
    ...
    return (
        <>
            ...
            <div
                className={`${colorClasses[0]} ${colorClasses[1]} rounded-lg p-4 mb-6`}
            >
                ...
                <div className="space-y-4">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="space-y-2 max-h-64 overflow-y-auto">
                                {group.lessons.map((lesson) => (
                                    <label
                                        key={lesson.lessonId}
                                        className={`flex items-start p-3 border rounded-lg cursor-pointer transition-colors ${selectedCanonical === lesson.lessonId
                                        ...
                                        <div className="space-y-2">
                                            {group.lessons
                                                ...
                                                .map((lesson) => (
                                                    <label
                                                        key={lesson.lessonId}
                                                        className={`flex items-start p-2 border rounded cursor-pointer ${splitSelections[subGroup.groupName] === lesson.lessonId
                                                                ? 'border-blue-500 bg-blue-50'
                                                                : 'border-gray-200 hover:bg-gray-50'
                                                            }`}
                                                    >
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200">
                        <button
                            ...
                            className={`w-full flex items-center justify-center px-4 py-2 rounded-lg text-white font-medium transition-colors ${resolving || (resolutionMode === 'single' && !selectedCanonical)
