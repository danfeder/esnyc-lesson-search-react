  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden animate-scale-in">
          {/* Header */}
          <div className="bg-gradient-to-r from-primary-500 to-primary-600 text-white p-6 relative">
            ...
            <div className="pr-12">
              <div className="flex items-start justify-between mb-4">
                <DialogTitle as="h1" className="text-2xl font-bold leading-tight">
                  {lesson.title}
                </DialogTitle>
              </div>
